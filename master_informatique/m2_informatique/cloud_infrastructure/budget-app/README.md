...
Dans un autre terminal vous pouvez accedez aux informations stockées dans la base de données une fois tout les services démarrées via la commande: "docker exec -it bdd psql -U your_db_user -d budget_db"
...
Pour redémarrer les services et reconstruire les images si nécessaire : "docker-compose up (--build)"
